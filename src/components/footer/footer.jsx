        ...
        <footer>
            ...
            <p className="rights">&copy; 2024 My Website. All Rights Reserved.</p>
                <div className="avatar-div">
                    ...
                    <img src = "images/avatar_1.png" alt="avatar icon" width="50px" className="avatar-icon"/>
                    </a>
                    <a href="https://github.com/chrisS-88" target="_blank">
                    <img src="images/avatar_4.png" alt="avatar icon" width="50px" className="avatar-icon"/>
                    </a>
                    <a href="https://github.com/Avr99j" target="_blank">
                    <img src="images/avatar_2.png" alt="avatar icon" width="50px" className="avatar-icon"/>
                    </a>
